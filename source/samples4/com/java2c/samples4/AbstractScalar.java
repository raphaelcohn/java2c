...
public abstract class AbstractScalar<T extends AbstractScalar<T>> implements CType
{
	...
	{
		throw new UnsupportedOperationException("equals is not supported for ScalarTypeBase");
	}

	@Override
	public final int hashCode()
	{
		throw new UnsupportedOperationException("hashCode  is not supported for ScalarTypeBase");
	}
	...
	public final <V extends AbstractScalar<V>> V cast(@NotNull final Class<V> to)
	{
		...
		{
			throw new IllegalStateException(format(ENGLISH, "It is a class definition error to not have a public constructor that takes a value for a scalar type '%1$s'", to.getSimpleName()), e);
		}
		try
		{
		...
		{
			throw new IllegalStateException(format(ENGLISH, "It is a class definition error to not be able to instantiate using a constructor that takes a value for a scalar type '%1$s'", to.getSimpleName()), e);
		}
		catch (IllegalAccessException e)
		{
			throw new IllegalStateException(format(ENGLISH, "It is a class definition error to not be able to access a constructor that takes a value for a scalar type '%1$s'", to.getSimpleName()), e);
		}
		catch (InvocationTargetException e)
		{
			throw new IllegalStateException(format(ENGLISH, "It is a class definition error to not be able to invoke a constructor that takes a value for a scalar type '%1$s'", to.getSimpleName()), e);
		}
	}
