...
public final class uint_least8_t extends AbstractScalar<uint_least8_t> implements Equality<uint_least8_t>, Comparison<uint_least8_t>, Mathematics<uint_least8_t>, BooleanAlgebra<uint_least8_t>
{
	...
	@Override
	public boolean isEqual(@NotNull final uint_least8_t right)
	{
		return super.isEqual(right);
	}

	@Override
	public boolean isNotEqual(@NotNull final uint_least8_t right)
	{
		return super.isNotEqual(right);
	}

	@Override
	public boolean isGreaterThan(@NotNull final uint_least8_t right)
	{
		return super.isGreaterThan(right);
	}

	@Override
	public boolean isLessThan(@NotNull final uint_least8_t right)
	{
		return super.isLessThan(right);
	}

	@Override
	public boolean isGreaterThanOrEqualTo(@NotNull final uint_least8_t right)
	{
		return super.isGreaterThanOrEqualTo(right);
	}

	@Override
	public boolean isLessThanOrEqualTo(@NotNull final uint_least8_t right)
	{
