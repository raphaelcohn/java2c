...
public final class int_fast32_t extends AbstractScalar<int_fast32_t> implements Equality<int_fast32_t>, Comparison<int_fast32_t>, SignedMathematics<int_fast32_t>, BooleanAlgebra<int_fast32_t>
{
	...
	@Override
	public boolean isEqual(@NotNull final int_fast32_t right)
	{
		return super.isEqual(right);
	}

	@Override
	public boolean isNotEqual(@NotNull final int_fast32_t right)
	{
		return super.isNotEqual(right);
	}

	@Override
	public boolean isGreaterThan(@NotNull final int_fast32_t right)
	{
		return super.isGreaterThan(right);
	}

	@Override
	public boolean isLessThan(@NotNull final int_fast32_t right)
	{
		return super.isLessThan(right);
	}

	@Override
	public boolean isGreaterThanOrEqualTo(@NotNull final int_fast32_t right)
	{
		return super.isGreaterThanOrEqualTo(right);
	}

	@Override
	public boolean isLessThanOrEqualTo(@NotNull final int_fast32_t right)
	{
