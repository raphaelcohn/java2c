...
public final class int_least8_t extends AbstractScalar<int_least8_t> implements Equality<int_least8_t>, Comparison<int_least8_t>, SignedMathematics<int_least8_t>, BooleanAlgebra<int_least8_t>
{
	...
	@Override
	public boolean isEqual(@NotNull final int_least8_t right)
	{
		return super.isEqual(right);
	}

	@Override
	public boolean isNotEqual(@NotNull final int_least8_t right)
	{
		return super.isNotEqual(right);
	}

	@Override
	public boolean isGreaterThan(@NotNull final int_least8_t right)
	{
		return super.isGreaterThan(right);
	}

	@Override
	public boolean isLessThan(@NotNull final int_least8_t right)
	{
		return super.isLessThan(right);
	}

	@Override
	public boolean isGreaterThanOrEqualTo(@NotNull final int_least8_t right)
	{
		return super.isGreaterThanOrEqualTo(right);
	}

	@Override
	public boolean isLessThanOrEqualTo(@NotNull final int_least8_t right)
	{
